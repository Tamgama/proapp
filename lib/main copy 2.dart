...
class HomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ListView(
      children: <Widget>[
        Card(
          color: Color.fromARGB(98, 172, 197, 342),
          child: Padding(
            padding: EdgeInsets.all(0.0), // padding tarjeta
            child: Image.asset("../assets/casa1.png"),
          ),
        )
      ],
    );
...
//   var foto = pair.asset("../assets/casa1.png");

//   @override
//   Widget build(BuildContext context) {
//     return Card(
//       color: Color.fromARGB(98, 173, 197, 243), // color tarjeta
//       child: Padding(
//         padding: const EdgeInsets.all(20), // padding tarjeta
//         child: Image.asset("../assets/casa1.png"),
//       ),
//     );
//   }
...
class CardItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      // const para q se mantenga igual aunq haya variaciones de pantalla
      child: ListView(
        children: [
          SizedBox(height: 10),
          Row(
